      ...
      <div className={styles.essay}>
        ...
        <div className={styles.essayBody}>
          ...
          <p>
            ...
            its ability to reciprocate the feelings that you feel towards it. I
            am unsatisfied with the ways that prose has been reduced into its
            strictly narrative uses. I would like to instead propose the
            alternatives. Prose as an organism to observe. Prose as a structure
            to move through. Prose as amassed data to investigate. It is not my
            intention to erase narrative, only to expand the potentialities of
            the medium. To arrange new texts in the periphery, at the boundary
            ...
            the monitor. I handed this program the language that it contorts,
            but I did not tell it what to say. The text is a
            procedurally-generated metaphysics. Proto-philosopher uploaded into
            an executable. With each activation rendering a new tome in the
            expanded field. Weaving old language into new incomprehensible
            hypotheses. In the same manner as other philosophical tomes, like
            Being and Nothingness or Critique of Pure Reason, I do not expect
            ...
            here. It is a postmodern structure, or maybe better than that, it is
            a completely enigmatic structure. The user takes up a kind of
            investigative position, speculating the nature of the struck-through
            text. Perhaps it is the truth that has peeked through the fog, bound
            and dragged back. You see it as it is roped away. Perhaps it is
            there to lead you astray. I cannot say. The fluctuations of Minor
            give a strange kind of rhythm. It is the most active reading that
            takes place in the text. Its arrangement feels more purposeful.
            Moving through it, there is the sense that some architect has
            designed this place, that someone / something built it. Minor is the
            final structure. It is the text in its most overtly architectural
            form. Its materials have become so familiar that they have lost
            their meaning. All that is left is the ways that they have been laid
            onto their foundation.
          </p>
          <p>
            But this is only my interpretation of the text. Writing has nothing
            to do with meaning. It has to do with land-surveying and
            cartography, including the mapping of countries yet to come
            (Deleuze). This text is not bound by my intentions. I did not write
            this book. I spawned the abstract machine that did, I arranged the
            text, but I did not write it. I have not even read it in its
            entirety. There is no misinterpretation of the text because there is
            no meaning that guides it. The purpose of the text is to do as the
            user desires it to. To take on the form and function that is
            demanded of it. This essay is not meant to limit your encounter with
            the text, but to offer two methods by which it might be navigated.
            It is here partially to remind you that the book is not a book. It
            is a strange textual-object. I do not know if there will be a
            digital copy of the text. Part of me hopes there will not be.
            Another part of me wonders how the experiences will differ (perhaps
            the digital iteration would generate procedurally, and truly feel
            like it is a living organism, mutating in front of you). The
            physical iteration of Generative Strata emanates a strange aura that
            I do not think could exist digitally, not without mutating into a
            completely different kind of strange. In this random nothingness,
            the object appears sacred. Recycling the tools of its lexicon into
            something large and mystifying. Where each moment of comprehension
            is an anomaly. And the user is left to construct their own meaning.
          </p>
        </div>
      </div>
    </>
